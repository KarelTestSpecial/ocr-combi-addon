...
const STRINGS = {
  ...
  en: {
    ...
    step2Instruction: "Select the Google documents you want to combine, choose the sort order, and combine them into one file.",
    ...
    errorNoOcrDocs: "No Google documents selected.",
  ...
  nl: {
    ...
    step2Instruction: "Selecteer de Google-documenten die u wilt combineren, kies de sorteervolgorde en voeg ze samen tot één bestand.",
    ...
    errorNoOcrDocs: "Geen Google-documenten geselecteerd.",
